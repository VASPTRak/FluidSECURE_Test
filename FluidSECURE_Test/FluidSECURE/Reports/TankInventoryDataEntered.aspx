<%@ Page Title="Tank Inventory Data Entered" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TankInventoryDataEntered.aspx.vb" Inherits="Fuel_Secure.TankInventoryDataEntered" %>
        ...
        <ContentTemplate>
            <div class="panel panel-primary" style="margin: 20px;">
                <div class="panel-heading  text-center">
                    <asp:Label class="panel-title" ID="lblHeader" runat="server">Tank Inventory Data Entered Report</asp:Label>
                </div>
