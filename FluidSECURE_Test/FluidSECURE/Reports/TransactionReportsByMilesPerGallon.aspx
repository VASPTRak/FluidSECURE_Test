            ...
            <div class="panel panel-primary" style="margin: 20px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="TXT_MPGKLessThan" CssClass="form-control input-sm" TabIndex="7" runat="server" MaxLength="20" Width="200"></asp:TextBox>
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="TXT_MPGKGreaterThan" CssClass="form-control input-sm" TabIndex="8" runat="server" MaxLength="20" Width="200"></asp:TextBox>
