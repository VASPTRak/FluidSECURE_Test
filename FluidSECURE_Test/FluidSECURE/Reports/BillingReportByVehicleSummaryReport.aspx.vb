		...
		Try
			...
			Else
				If (Not IsPostBack) Then
					...
					RPT_BillingReportByVehicleSummary.LocalReport.SetParameters(New ReportParameter() {FromDate, ToDate, TransactionType, TransactionStatusText, FuelingTypeCurrent, FuelingTypePrevious})
