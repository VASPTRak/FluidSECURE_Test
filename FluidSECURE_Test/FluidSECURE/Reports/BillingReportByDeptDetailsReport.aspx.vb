		...
		Try
			...
			Else
				If (Not IsPostBack) Then
					...
					RPT_BillingReportByDeptDetails.LocalReport.SetParameters(New ReportParameter() {FromDate, ToDate, TransactionType, TransactionStatusText, FuelingTypeCurrent, FuelingTypePrevious})
