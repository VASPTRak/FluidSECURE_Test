...
#Region "Customer"
    ...
    Public Function GetCustMenuMapingById(Condition As String, customerId As Integer) As DataTable
        Dim dal = New GeneralizedDAL()
        Try
            Dim ds As DataSet = New DataSet()
            ...
            ds = dal.ExecuteStoredProcedureGetDataSet("usp_tt_Customer_GetCustMenuMapingById", Param)

            Return ds.Tables(0)
        Catch ex As Exception
            log.Error("Error occurred in GetCustMenuMapingById Exception is :" + ex.Message)
            Return Nothing
        End Try
    End Function

    Public Function SetEnableDisableVehOdoByCustID(flagEnableDisable As Boolean, customerId As Integer) As Integer
        Dim dal = New GeneralizedDAL()
        Try
            ...
            Param(0) = New SqlParameter("@flagEnableDisable", SqlDbType.Bit)
            Param(0).Direction = ParameterDirection.Input
            Param(0).Value = flagEnableDisable

            Param(1) = New SqlParameter("@CustomerId", SqlDbType.Int)
            Param(1).Direction = ParameterDirection.Input
            Param(1).Value = customerId

            result = dal.ExecuteStoredProcedureGetInteger("usp_tt_Customer_SetEnableDisableVehOdoByCustID", Param)
    ...
    Public Function GetStateCountryFromCustomers(CustomerId As Integer) As DataSet
        Dim dal = New GeneralizedDAL()
        Try
            Dim ds As DataSet = New DataSet()
            ...
            ds = dal.ExecuteStoredProcedureGetDataSet("usp_tt_Report_GetStateCountryFromCustomers", Param)
...
#Region "Personnel"
    ...
    Public Function GetPersonIdByCondition(PersonId As Integer, IsFirst As Boolean, IsLast As Boolean, IsNext As Boolean, IsPrevious As Boolean, IsCount As Boolean, LoginPersonId As Integer, RoleId As String, CustomerId As Integer, IsHub As Boolean, Conditions As String) As DataTable
        ...
        Try
            ...
            Param(10) = New SqlParameter("@LoginPersonId", SqlDbType.Int)
            Param(10).Direction = ParameterDirection.Input
            Param(10).Value = LoginPersonId
    ...
    Public Function GetGroupAdminCompanyMapping(PersonId As Integer) As DataTable
        ...
        Try
            ...
            ds = dal.ExecuteStoredProcedureGetDataSet("usp_tt_Personnel_GetGroupAdminCompanyMapping", Param)

            Return ds.Tables(0)

        Catch ex As Exception
            log.Error("Error occurred in GetGroupAdminCompanyMapping Exception is :" + ex.Message)
            Return Nothing
        Finally
...
#Region "Vehicles"
    ...
    Public Function SaveUpdateVehicle(VehicleId As Integer, VehicleName As String, Make As String, Model As String, Year As Integer, LicensePlateNumber As String,
        ...
        Try
            ...
            Dim ParLicensePlateNumber = New SqlParameter("@LicensePlateNumber", SqlDbType.NVarChar, 9)
...
#Region "Report"
	...
	Public Function SpecializedExportTransactions(startDate As String, endDate As String, Condition As String) As DataSet
        ...
        Try
            ...
            ds = dal.ExecuteStoredProcedureGetDataSet("usp_tt_Report_SpecializedExportTransactions", parcollection)

            Return ds

        Catch ex As Exception
            log.Error("Error occurred in SpecializedExportTransactions Exception is :" + ex.Message)
            Return Nothing
        Finally
        End Try
    End Function
    ...
    Public Function GetShipmentDetails(Condition As String, ShipmentFor As Integer) As DataTable
        Dim dal = New GeneralizedDAL()
        Try
            Dim parcollection() As SqlParameter = New SqlParameter(1) {}
            Dim ds = New DataSet()
            ...
            parcollection(1) = New SqlParameter("@ShipmentForLinkOrHub", SqlDbType.Int)
            parcollection(1).Direction = ParameterDirection.Input
            parcollection(1).Value = ShipmentFor
    ...
    Public Function GetTotalFuelUsageByHubPerVehicleRptDetails(Condition As String, startDate As String, endDate As String) As DataSet
        Dim dal = New GeneralizedDAL()
        Try
            Dim parcollection() As SqlParameter = New SqlParameter(2) {}
            Dim ds = New DataSet()
            ...
            parcollection(1) = New SqlParameter("@StartDateTime", SqlDbType.NVarChar, 500)
            parcollection(1).Direction = ParameterDirection.Input
            parcollection(1).Value = startDate

            parcollection(2) = New SqlParameter("@EndDateTime", SqlDbType.NVarChar, 500)
            parcollection(2).Direction = ParameterDirection.Input
            parcollection(2).Value = endDate

            ds = dal.ExecuteStoredProcedureGetDataSet("usp_tt_Report_GetTotalFuelUsageByHubPerVehicleDetails", parcollection)

            Return ds

        Catch ex As Exception
            log.Error("Error occurred in GetTotalFuelUsageByHubPerVehicleRptDetails Exception is :" + ex.Message)
            Return Nothing
        Finally
        End Try
    End Function

    Public Function GetInactiveVehicleReport(startDate As String, endDate As String, DepartmentId As Integer, CustomerId As Integer) As DataSet
        Dim dal = New GeneralizedDAL()
        Try
            Dim parcollection() As SqlParameter = New SqlParameter(3) {}
            Dim ds = New DataSet()
            ...
            parcollection(2) = New SqlParameter("@DepartmentId", SqlDbType.Int)
            parcollection(2).Direction = ParameterDirection.Input
            parcollection(2).Value = DepartmentId

            parcollection(3) = New SqlParameter("@CustomerId", SqlDbType.Int)
            parcollection(3).Direction = ParameterDirection.Input
            parcollection(3).Value = CustomerId

            ds = dal.ExecuteStoredProcedureGetDataSet("usp_tt_Report_GetInactiveVehicleReport", parcollection)

            Return ds

        Catch ex As Exception
            log.Error("Error occurred in GetInactiveVehicleReport Exception is :" + ex.Message)
            Return Nothing
        Finally
        End Try
    End Function

    Public Function GetInventoryForecastReport(startDate As String, endDate As String, TankNo As String, CustomerId As String, Threshold As String) As DataSet
        Dim dal = New GeneralizedDAL()
        Try
            Dim parcollection() As SqlParameter = New SqlParameter(4) {}
            Dim ds = New DataSet()
            ...
            parcollection(2) = New SqlParameter("@TanKNumber", SqlDbType.NVarChar, 500)
            parcollection(2).Direction = ParameterDirection.Input
            parcollection(2).Value = TankNo

            parcollection(3) = New SqlParameter("@CustomerId", SqlDbType.NVarChar, 10)
            parcollection(3).Direction = ParameterDirection.Input
            parcollection(3).Value = CustomerId

            parcollection(4) = New SqlParameter("@ThresholdValue", SqlDbType.NVarChar, 10)
            parcollection(4).Direction = ParameterDirection.Input
            parcollection(4).Value = Threshold

            ds = dal.ExecuteStoredProcedureGetDataSet("usp_tt_Report_InventoryForecastReport", parcollection)

            Return ds

        Catch ex As Exception
            log.Error("Error occurred in GetInventoryForecastReport Exception is :" + ex.Message)
            Return Nothing
        Finally
        End Try
    End Function

    Public Function GetStateCountryWiseCustomerDetails(Condition As String) As DataSet
        Dim dal = New GeneralizedDAL()
        Try
            Dim parcollection() As SqlParameter = New SqlParameter(0) {}
            Dim ds = New DataSet()

            parcollection(0) = New SqlParameter("@Condition", SqlDbType.NVarChar, 500)
            parcollection(0).Direction = ParameterDirection.Input
            parcollection(0).Value = Condition

            ds = dal.ExecuteStoredProcedureGetDataSet("usp_tt_Report_GetStateCountryWiseCustomerDetails", parcollection)

            Return ds

        Catch ex As Exception
            log.Error("Error occurred in GetStateCountryWiseCustomerDetails Exception is :" + ex.Message)
            Return Nothing
        Finally
        End Try
    End Function
...
#Region "Shipment"
    ...
    Public Function CheckShipmentCardReaderSerialNumberExist(ByVal SerialNumber As String, ShipmentId As Integer) As Integer
        ...
        Try
            Dim parcollection(1) As SqlParameter
            Dim ParSerialNumber = New SqlParameter("@SerialNumber", SqlDbType.NVarChar, 32)
            ParSerialNumber.Direction = ParameterDirection.Input
            ParSerialNumber.Value = SerialNumber
            parcollection(0) = ParSerialNumber
            ...
            Return dal.ExecuteStoredProcedureGetInteger("usp_tt_Shipment_CheckCardReaderSerialNumberExist", parcollection)

        Catch ex As Exception
            log.Error("Error occurred in CCheckCardReaderSerialNumberExist Exception is :" + ex.Message)
            Return 0
    ...
    Public Function SaveUpdateShipment(ShipmentId As Integer, FluidSecureUnitName As String, Company As String, Address As String,
                                       UserId As Integer, PhoneNumber As String, ShipmentDate As DateTime, CompanyId As Integer, HubName As String, IsReplacement As Boolean,
                                       ReplacementForSiteId As Integer, ReplacementForHubId As Integer, IsReturned As Boolean, ReturnedOn As DateTime,
                                       ShipmentForLinkOrHub As Integer, SerialNumber As String, Frequency As String, HubForCardReader As Integer) As Integer
        Try
            Dim result As Integer
            Dim dal = New GeneralizedDAL()
            ...
            Dim ParPhoneNumber = New SqlParameter("@PhoneNumber", SqlDbType.NVarChar, 30)
            ...
            Dim ParSerialNumber = New SqlParameter("@SerialNumber", SqlDbType.NVarChar, 50)
            Dim ParFrequency = New SqlParameter("@Frequency", SqlDbType.NVarChar, 15)
            Dim ParHubForCardReader = New SqlParameter("@HubForCardReader", SqlDbType.Int)
            ...
            ParSerialNumber.Direction = ParameterDirection.Input
            ParFrequency.Direction = ParameterDirection.Input
            ParHubForCardReader.Direction = ParameterDirection.Input
            ...
            ParSerialNumber.Value = SerialNumber
            ParFrequency.Value = Frequency
            ParHubForCardReader.Value = HubForCardReader

            parcollection(0) = ParShipmentId
            parcollection(1) = ParFluidSecureUnitName
            parcollection(2) = ParCompany
            parcollection(3) = ParAddress
            parcollection(4) = ParPhoneNumber
            parcollection(5) = ParUserId
            parcollection(6) = ParShipmentDate
            parcollection(7) = ParCompanyId
            parcollection(8) = ParHubName
            parcollection(9) = ParIsReplacement
            parcollection(10) = ParReplacementForSiteId
            parcollection(11) = ParReplacementForHubId
            parcollection(12) = ParIsReturned
            parcollection(13) = ParReturnedOn
            parcollection(14) = ParShipmentForLinkOrHub
            parcollection(15) = ParSerialNumber
            parcollection(16) = ParFrequency
            parcollection(17) = ParHubForCardReader
...
#Region "AutoTransactionExportSettings"
    ...
    Public Function GetAutoTransactionExportSettingIdByCondition(AutoTransactionExportSettingId As Integer, IsFirst As Boolean, IsLast As Boolean, IsNext As Boolean,
                                                                 IsPrevious As Boolean, IsCount As Boolean, RoleId As String, LoginPersonId As Integer, Conditions As String) As Integer
        Dim dal = New GeneralizedDAL()
        Try
            ...
            Param(8) = New SqlParameter("@Conditions", SqlDbType.NVarChar, 2000)
            Param(8).Direction = ParameterDirection.Input
            Param(8).Value = Conditions
...
#Region "Upload FSVMFirmware"
    Public Function SaveUpdateFSVMFirmware(FSVMFirmwareId As Integer, FSVMFirmwareFileName As String, FSVMFirmwareFilePath As String, Version As String, UserId As Integer, FSVMFileType As Integer) As Integer
        Try
            Dim result As Integer
            Dim dal = New GeneralizedDAL()
            Dim parcollection(5) As SqlParameter
            ...
            Dim ParVersion = New SqlParameter("@Version", SqlDbType.NVarChar, 2000)
            Dim ParUserId = New SqlParameter("@UserId", SqlDbType.Int)
            Dim ParFSVMFileType = New SqlParameter("@FSVMFileType", SqlDbType.Int)
            ...
            ParVersion.Direction = ParameterDirection.Input
            ParUserId.Direction = ParameterDirection.Input
            ParFSVMFileType.Direction = ParameterDirection.Input
            ...
            ParVersion.Value = Version
            ParUserId.Value = UserId
            ParFSVMFileType.Value = FSVMFileType
            ...
            parcollection(3) = ParVersion
            parcollection(4) = ParUserId
            parcollection(5) = ParFSVMFileType
...
#Region "Upload FSNP Firmware"
    ...
    Public Function CheckLaunchedAndExistedFSNPVersionAndUpdate(SiteId As String, version As String, personId As Integer, flag As Integer) As DataSet
        Try
            Dim result As DataSet
            Dim dal = New GeneralizedDAL()
            Dim parcollection(3) As SqlParameter

            Dim ParSSID = New SqlParameter("@SiteId", SqlDbType.NVarChar, 200)
            Dim Parversion = New SqlParameter("@version", SqlDbType.NVarChar, 200)
            Dim ParpersonId = New SqlParameter("@personId", SqlDbType.Int)
            Dim Parflag = New SqlParameter("@flag", SqlDbType.Int)

            ParSSID.Direction = ParameterDirection.Input
            ParSSID.Value = SiteId
            parcollection(0) = ParSSID
            ...
            result = dal.ExecuteStoredProcedureGetDataSet("usp_tt_FSNP_CheckLaunchedAndExistedFSNPVersionAndUpdate", parcollection)
...
#Region "Specialized Features"

    Public Function GetCustomerMenuLinkMasterByCondition(Conditions As String) As DataTable
        Dim dal = New GeneralizedDAL()
        Try
            Dim parcollection() As SqlParameter = New SqlParameter(0) {}
            Dim ds = New DataSet()
            ...
            ds = dal.ExecuteStoredProcedureGetDataSet("usp_tt_Customer_GetCustomerMenuLinkMaster", parcollection)

            Return ds.Tables(0)

        Catch ex As Exception
            log.Error("Error occurred in GetGetCustomerMenuLinkMasterByCondition Exception is :" + ex.Message)
            Return Nothing
        Finally
        End Try
    End Function

    Public Function SaveUpdateSpecializedFeature(CustomerMenuLinkId As Integer, Name As String, UserId As Integer) As Integer
        Try
            Dim result As Integer
            Dim dal = New GeneralizedDAL()
            Dim parcollection(2) As SqlParameter
            Dim ParCustomerMenuLinkId = New SqlParameter("@CustomerMenuLinkId", SqlDbType.Int)
            Dim ParName = New SqlParameter("@Name", SqlDbType.NVarChar, 2000)
            Dim ParUserId = New SqlParameter("@UserId", SqlDbType.Int)

            ParCustomerMenuLinkId.Direction = ParameterDirection.Input
            ParName.Direction = ParameterDirection.Input
            ParUserId.Direction = ParameterDirection.Input

            ParCustomerMenuLinkId.Value = CustomerMenuLinkId
            ParName.Value = Name
            ParUserId.Value = UserId

            parcollection(0) = ParCustomerMenuLinkId
            parcollection(1) = ParName
            parcollection(2) = ParUserId

            result = dal.ExecuteStoredProcedureGetInteger("usp_tt_Customer_InsertUpdateCustomerMenuLinkMaster", parcollection)

            Return result
        Catch ex As Exception
            log.Error("Error occurred in SaveUpdateSpecializedFeature Exception is :" + ex.Message)
            Return 0
    ...
    Public Function DeleteCustomerMenuLinkMapping(CustomerMenuLinkId As Integer, CustomerId As Integer) As Integer
        Try
            Dim dal = New GeneralizedDAL()
            Dim Param As SqlParameter() = New SqlParameter(1) {}
            ...
            Param(0) = New SqlParameter()
            Param(0).ParameterName = "@CustomerMenuLinkId"
            Param(0).SqlDbType = SqlDbType.Int
            Param(0).Direction = ParameterDirection.Input
            Param(0).Value = CustomerMenuLinkId

            Param(1) = New SqlParameter()
            Param(1).ParameterName = "@CustomerId"
            Param(1).SqlDbType = SqlDbType.Int
            Param(1).Direction = ParameterDirection.Input
            Param(1).Value = CustomerId

            Dim result As Integer = dal.ExecuteStoredProcedureTableValuePrameter("usp_tt_Customer_DeleteCustomerMenuLinkMapping", Param)

            Return 1
        Catch ex As Exception
            log.Error("Error occurred in DeleteCustomerMenuLinkMapping Exception is :" + ex.Message)
            Return 0
        Finally
            'sqlConn.Close()
        End Try
    ...
    Public Function InsertCustomerMenuLinkMapping(dtCustomerMenuLinkMapping As DataTable) As Integer
        Try
            Dim dal = New GeneralizedDAL()
            Dim Param As SqlParameter() = New SqlParameter(0) {}
            ...
            Param(0) = New SqlParameter()
            Param(0).ParameterName = "@dtCustomerMenuLinkMapping"
            Param(0).SqlDbType = SqlDbType.Structured
            Param(0).Direction = ParameterDirection.Input
            Param(0).Value = dtCustomerMenuLinkMapping
            Param(0).TypeName = "dbo.CustomerMenuLinkMapping"



            Dim result As Integer = dal.ExecuteStoredProcedureTableValuePrameter("usp_tt_Customer_InsertCustomerMenuLinkMapping", Param)

            Return 1
        Catch ex As Exception
            log.Error("Error occurred in InsertCustomerMenuLinkMapping Exception is :" + ex.Message)
            Return 0
        Finally
            'sqlConn.Close()
        End Try
    ...
    Public Function GetCustomerMenuLinkMappingByCustomerMenuLinkId(CustomerMenuLinkId As Integer) As DataTable
        Dim result As DataSet
        Try
            ...
            result = dal.ExecuteStoredProcedureGetDataSet("usp_tt_Customer_GetCustomerMenuLinkMapping", parcollection)

            Return result.Tables(0)
        Catch ex As Exception
            log.Error("Error occurred in GetCustomerMenuLinkMappingByCustomerMenuLinkId Exception is :" + ex.Message)
            Return Nothing
    ...
    Public Function DeleteCustomerMenuLink(ByVal CustomerMenuLink As Integer, UserId As Integer) As Integer
        Dim dal = New GeneralizedDAL()
        Try
            Dim parcollection(1) As SqlParameter
            Dim ParCustomerMenuLinkId = New SqlParameter("@CustomerMenuLinkId", SqlDbType.Int)
            ParCustomerMenuLinkId.Direction = ParameterDirection.Input
            ParCustomerMenuLinkId.Value = CustomerMenuLink
            parcollection(0) = ParCustomerMenuLinkId
            ...
            Dim result As Integer = dal.ExecuteStoredProcedureGetInteger("usp_tt_Customer_DeleteCustomerMenuLinkMaster", parcollection)
            Return result
        Catch ex As Exception
            log.Error("Error occurred in DeleteCustomerMenuLink Exception is :" + ex.Message)
            Return 0
        End Try
    End Function

    Public Function GetCustomerMenuLinkMasterDetails() As DataTable
        Dim result As DataSet
        Try

            Dim dal = New GeneralizedDAL()

            result = dal.ExecuteStoredProcedureGetDataSet("usp_tt_Customer_GetCustomerMenuLinkMasterDetails")

            Return result.Tables(0)
        Catch ex As Exception
            log.Error("Error occurred in GetCustomerMenuLinkMasterDetails Exception is :" + ex.Message)
            Return Nothing
