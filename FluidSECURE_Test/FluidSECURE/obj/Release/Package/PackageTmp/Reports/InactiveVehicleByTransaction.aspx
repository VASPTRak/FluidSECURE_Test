<%@ Page Title="Inactive vehicle report" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="InactiveVehicleByTransaction.aspx.vb" Inherits="Fuel_Secure.InactiveVehicleByTransaction" %>
        ...
        <ContentTemplate>
            ...
            <div class="panel panel-primary" style="margin: 20px;">
                <div class="panel-heading  text-center">
                    <asp:Label class="panel-title" ID="lblHeader" runat="server">Inactive Vehicle Report</asp:Label>
                </div>
