<%@ Page Title="Firmware Upgrades" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="FirmwareUpgrades.aspx.vb" Inherits="Fuel_Secure.FirmwareUpgrades" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-primary" style="margin: 20px;">
        <asp:HiddenField ID="hdfFirmwareID" runat="server" Value="" />
        <div class="panel-heading  text-center">
            <asp:Label class="panel-title" ID="lblHeader" runat="server">Upload Firmware</asp:Label>
        </div>
        <div class="panel-body">
            ...
            <div class="row col-md-12 col-sm-12 col-xs-12" runat="server" id="Uploaddiv">
                ...
                <div class="form-group col-md-3 col-sm-3 col-xs-12">
                    <asp:TextBox ID="txtfirmwareversionnumber" CssClass="form-control input-sm" TabIndex="1" runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RFDfirmwareversionnumber" runat="server" ControlToValidate="txtfirmwareversionnumber"
                        ErrorMessage="Please Enter Firmware version number." Display="Dynamic" ForeColor="Red" SetFocusOnError="True" ValidationGroup="FirmwareValidation"></asp:RequiredFieldValidator>
                </div>
                <div>
                    <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                        <label>
            ...
            <div class="row col-md-12 col-sm-12 col-xs-12" runat="server" id="ViewDiv">
                <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                    <label>
                        Firmware version number:</label>
                </div>
                <div class="form-group col-md-3 col-sm-3 col-xs-12">
                    <asp:Label runat="server" ID="lblFirmwareName"></asp:Label>
                </div>
                <div>
                    <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                        <label>
            ...
            <div class="row col-md-12 col-sm-12 text-center col-xs-12">
                <asp:Button ID="btnSave" CssClass="btn btn-primary" runat="server" OnClick="btnSave_Click" Text="Save" Width="100px"
                    UseSubmitBehavior="true" TabIndex="9" ValidationGroup="FirmwareValidation" />
