...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            ...
                            <asp:HiddenField ID="HDF_GroupAdmin" runat="server" />
                        </div>
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                            <label>
                   ...
                   <%-- <div class="row col-md-12 col-sm-12 col-xs-12" id="divMappCompanies" runat="server">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:CheckBox ID="chkIsApproved" runat="server" TabIndex="20" Checked="true" OnClick="javascript:ConfirmActiveInactive(this);" />
                        </div>
                    </div>
    ...
    <script>
        ...
        function ConfirmActiveInactive(CheckActiveConfirm) {
            var checkPersonnelIdValue = $('#<%=HDF_PersonnelId.ClientID %>').val()

            if (checkPersonnelIdValue != "") {
