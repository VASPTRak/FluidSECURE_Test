			...
			<div class="panel panel-primary" style="margin: 20px;">
				...
				<div class="panel-body">
					<div class="row col-md-12 col-sm-12  col-xs-12">
						...
						<div class="form-group col-md-3 col-sm-3  col-xs-12" id="OtherThanDate" runat="server">
							...
							<asp:DropDownList runat="server" ID="DDL_Datetype" Visible="false" CssClass="form-control input-sm">
								<asp:ListItem Text="Select Entry Type" Value=""></asp:ListItem>
								<asp:ListItem Text="Level" Value="s"></asp:ListItem>
								<asp:ListItem Text="Receipt/Delivery" Value="se"></asp:ListItem>
							</asp:DropDownList>
							<asp:DropDownList ID="ddl_TankNo" CssClass="form-control input-sm" TabIndex="1" runat="server" Visible="false"></asp:DropDownList>
						</div>
					...
					<div class="col-md-12 col-sm-12  col-xs-12" style="overflow-x: auto">
						...
						<asp:GridView ID="gvTankInvt" CssClass="table table-bordered table-hover" runat="server" PageSize="10" AllowPaging="true" DataKeyNames="TankInventoryId,CostingMethod,ENTRY_TYPE"
							AutoGenerateColumns="False" AllowSorting="true" EmptyDataText="0 records found for selected search criteria"> <%--OnRowDataBound="gvTankInvt_RowDataBound"--%>
                            ...
                            <Columns>
								...
								<asp:TemplateField SortExpression="TankNumberNameForView" ItemStyle-HorizontalAlign="Center" HeaderText="Tank Number" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
									<ItemTemplate>
										<asp:Label ID="lblTankNumber" Text='<%# DataBinder.Eval(Container.DataItem, "TankNumberNameForView")%>'
											runat="server" />
									</ItemTemplate>
								</asp:TemplateField>
