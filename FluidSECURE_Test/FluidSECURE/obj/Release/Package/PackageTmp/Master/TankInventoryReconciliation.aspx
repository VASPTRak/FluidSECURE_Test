...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="modal fade" tabindex="-1" role="dialog" id="DELIWarningMessage">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row col-md-12 col-sm-12">
                        <asp:Label ID="Label1" runat="server" Text="Product price entered as 0. Are you sure you want continue with price as 0?"></asp:Label>
                    </div>
                </div>
                <div class="modal-footer nextButton">
                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-default" Text="No" OnClientClick="ClosePopUpDELIWarning()" />
                    <asp:Button ID="btnSaveDelivery" runat="server" class="btn btn-success" Text="Yes" OnClientClick="ClosePopUpDELIWarning()"  OnClick="btnSaveDelivery_Click" />
                    <input type="button" id="btnCloseDELIWarnMessage" class="btn btn-success" data-dismiss="modal" style="display: none;" value="Close" />
            ...
            <div class="panel panel-primary" style="margin: 20px;">
                ...
                <div class="panel-body">
                    ...
                    <div runat="server" id="StartDiv" class="row">
                        <div class="row col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group col-md-3 col-sm-3 textleft col-xs-12">
                                <h3 class="panel-title">Enter Tank Level</h3>
                            </div>
                        ...
                        <label class="text-danger font-required">[required]</label></label>
                            ...
                            <div class="form-group col-md-2 col-sm-2 col-xs-12">
                               ...
                               <%-- <asp:CompareValidator ID="CV_SQuantity" runat="server" Display="Dynamic" ErrorMessage="Please enter Quantity as Whole Number." ForeColor="Red" Operator="DataTypeCheck" SetFocusOnError="True"
                                    Type="Integer" ValidationGroup="StartTankValidation" ControlToValidate="txtStartLevelQuan"></asp:CompareValidator>--%>
                            </div>
                        </div>
                        <div class="row col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group col-md-2 col-sm-2 textright col-xs-12">
                    ...
                    <div runat="server" id="DeliDiv" class="row">
                        <div class="row col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group col-md-3 col-sm-3 textleft col-xs-12">
                            <h3 class="panel-title">Enter Tank Receipt/Delivery</h3>
                                </div>
                        </div>
                       ...
                       <%-- <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <label class="text-danger font-required">[required]</label>:</label>
                            ...
                            <div class="form-group col-md-2 col-sm-2 col-xs-12">
                                ...
                                <asp:RequiredFieldValidator ID="RFV_DELILevelQuan" runat="server" ControlToValidate="txtDELILevelQuan"
...
<%--                                <asp:CompareValidator ID="CV_RDQuantity" runat="server" Display="Dynamic" ErrorMessage="Please enter Quantity as Whole Number." ForeColor="Red" Operator="DataTypeCheck" SetFocusOnError="True"
                                    Type="Integer" ValidationGroup="DELITankValidation" ControlToValidate="txtDELILevelQuan"></asp:CompareValidator>--%>
                            </div>
                            <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                            ...
                            <div class="form-group col-md-2 col-sm-2 col-xs-12">
                               ...
                               <%-- <asp:RequiredFieldValidator ID="RFV_ProductPrice" runat="server" ControlToValidate="txtProductPrice"
                                    ErrorMessage="Please Enter Price." Display="Dynamic" ForeColor="Red" SetFocusOnError="True" ValidationGroup="DELITankValidation"></asp:RequiredFieldValidator>--%>
...
function OpenDeliEndTypeBox() {
    ...
    function ClosePopUpDELIWarning() {
        $("#btnCloseDELIWarnMessage").click();
        $('body').removeClass("modal-open");
        LoadDateTimeControl()

    }
    function CheckConfirmDeliWarning() {
        $('#DELIWarningMessage').modal({
            show: true,
            backdrop: 'static',
            keyboard: false
        });
