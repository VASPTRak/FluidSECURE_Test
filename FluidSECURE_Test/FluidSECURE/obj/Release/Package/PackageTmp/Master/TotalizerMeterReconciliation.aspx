                    ...
                    <div runat="server" id="StartDiv" class="row">
                        ...
                        <label class="text-danger font-required">[required]</label></label>
                            ...
                            <div class="form-group col-md-2 col-sm-2 col-xs-12">
                                ...
                                <asp:CompareValidator ID="CV_SQuantity" runat="server" Display="Dynamic" ErrorMessage="Please enter Totalizer/Meter Number as Whole Number." ForeColor="Red" Operator="DataTypeCheck" SetFocusOnError="True"
