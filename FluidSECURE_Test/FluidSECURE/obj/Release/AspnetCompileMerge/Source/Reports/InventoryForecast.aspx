<%@ Page Title="Inventory Forecast Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="InventoryForecast.aspx.vb" Inherits="Fuel_Secure.InventoryForecast" %>
        ...
        <ContentTemplate>
            ...
            <div class="panel panel-primary" style="margin: 20px;">
                <div class="panel-heading  text-center">
                    <asp:Label class="panel-title" ID="lblHeader" runat="server">Inventory Forecast Report</asp:Label>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList ID="ddl_TankNo" CssClass="form-control input-sm" TabIndex="5" runat="server"></asp:DropDownList>
                             <asp:RequiredFieldValidator ID="RDF_TankNo" runat="server" ControlToValidate="ddl_TankNo" Display="Dynamic"
                                ErrorMessage="Please select Tank Number." ForeColor="Red" InitialValue="0" SetFocusOnError="True" ValidationGroup="TransactionValidation"></asp:RequiredFieldValidator>
                        </div>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                            <label>
                                Tank Level Threshold:</label>
                        </div>
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="txtThreshold" runat="server" Width="150" CssClass="form-control input-sm" TabIndex="6"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RDF_Threshold" runat="server" ControlToValidate="txtThreshold"
                                    ErrorMessage="Please Enter Tank Level Threshold." Display="Dynamic" ForeColor="Red" SetFocusOnError="True" ValidationGroup="TransactionValidation"></asp:RequiredFieldValidator>
                                <asp:CompareValidator ID="CV_Threshold" runat="server" Display="Dynamic" ErrorMessage="Please enter Tank Level Threshold as Whole Number." ForeColor="Red" Operator="DataTypeCheck" SetFocusOnError="True"
                                    Type="Integer" ValidationGroup="TransactionValidation" ControlToValidate="txtThreshold"></asp:CompareValidator>
                        </div>
                    </div>
