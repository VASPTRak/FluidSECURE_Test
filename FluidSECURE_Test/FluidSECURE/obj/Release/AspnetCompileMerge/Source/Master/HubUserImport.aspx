<%@ Page Title="Hub User Import" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="HubUserImport.aspx.vb" Inherits="Fuel_Secure.HubUserImport" %>
            ...
            <div class="panel panel-primary" style="margin: 20px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div id="divCompanyImport" runat ="server" class="form-group col-md-3 col-sm-3 textright col-xs-12">
                            <label>
                                Company
                        <label class="text-danger font-required">[required]</label>:</label>
                        </div>
