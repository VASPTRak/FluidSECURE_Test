<%@ Page Title="TLD Firmware Upgrade" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TLDFirmwareUpgrades.aspx.vb" Inherits="Fuel_Secure.TLDFirmwareUpgrades" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-primary" style="margin: 20px;">
        <asp:HiddenField ID="hdfTLDFirmwareID" runat="server" Value="" />
        <div class="panel-heading  text-center">
            <asp:Label class="panel-title" ID="lblHeader" runat="server">Upload TLD Firmware</asp:Label>
        </div>
        <div class="panel-body">
            ...
            <div class="row col-md-12 col-sm-12 col-xs-12" runat="server" id="Uploaddiv">
                <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                    <label>
                        TLD Firmware version number
                        <label runat="server" id="lblRequired" class="text-danger font-required">[required]</label>:</label>
                </div>
                <div class="form-group col-md-3 col-sm-3 col-xs-12">
                    <asp:TextBox ID="txtTLDfirmwareversionnumber" CssClass="form-control input-sm" TabIndex="1" runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RFDTLDfirmwareversionnumber" runat="server" ControlToValidate="txtTLDfirmwareversionnumber"
                        ErrorMessage="Please Enter TLD Firmware version number." Display="Dynamic" ForeColor="Red" SetFocusOnError="True" ValidationGroup="TLDFirmwareValidation"></asp:RequiredFieldValidator>
                </div>
                <div>
                    <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                        <label>
                    ...
                    <div class="form-group col-md-3 col-sm-3 col-xs-12">
                        <asp:FileUpload ID="FU_Firware" runat="server" TabIndex="2" />
                        <asp:RequiredFieldValidator if="RDF_Firware" runat="server" Display="Dynamic" ErrorMessage="Please select file to upload." ControlToValidate="FU_Firware" ForeColor="Red" SetFocusOnError="True" ValidationGroup="FirmwareValidation"></asp:RequiredFieldValidator>
                    </div>
                </div>
            </div>
            <div class="row col-md-12 col-sm-12 col-xs-12" runat="server" id="ViewDiv">
                <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                    <label>
                        TLD Firmware version number:</label>
                </div>
                <div class="form-group col-md-3 col-sm-3 col-xs-12">
                    <asp:Label runat="server" ID="lblTLDFirmwareName"></asp:Label>
                </div>
                <div>
                    <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                        <label>
                            Uploaded firware:</label>
                    </div>
                    <div class="form-group col-md-3 col-sm-3 col-xs-12">
                        <asp:Label runat="server" ID="lblUploadfirware"></asp:Label>
                    </div>
                </div>
            </div>
            <div class="row col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-default" style="width: 100%; margin: 0 auto 0;">
                    <div class="panel-heading" style="text-align: center">
                        <h3 class="panel-title">Configure FluidSecure Tank</h3>
                    </div>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                                                    <asp:GridView ID="gvTanks" CssClass="table table-bordered table-hover" runat="server" AutoGenerateColumns="False" EmptyDataText="0 records found"
                                                                        DataKeyNames="TankId,TankNumberNameForView">
                                                                        <Columns>
                                                                            <asp:TemplateField>
                                                                                <HeaderTemplate>
                                                                                ...
                                                                                <ItemTemplate>
                                                                                    <asp:CheckBox ID="ChkTanks" runat="server" onclick="javascript:SelectboxTank(this);"></asp:CheckBox>
                                                                                </ItemTemplate>
                                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Tanks">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblVersion" Text='<%# DataBinder.Eval(Container.DataItem, "TankNumberNameForView")%>'
                                                                                        runat="server" />
                                                                                </ItemTemplate>
                                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                            </asp:TemplateField>
            ...
            <%--<div class="row col-md-12 col-sm-12 col-xs-12">
                <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                    <asp:Label Text="Fluid Tanks" ID="lblFluidTanks" Visible="false" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="Panel1" />
                </div>
                <div class="form-group col-md-9 col-sm-9 textright col-xs-12">
                    <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" Style="height: 570px" ToolTip="Fluid Tanks">
                    </asp:Panel>
                </div>
            </div>--%>
            <div class="row col-md-12 col-sm-12 text-center col-xs-12">
                <asp:Button ID="btnSave" CssClass="btn btn-primary" runat="server" OnClick="btnSave_Click" Text="Save" Width="100px"
                    UseSubmitBehavior="true" TabIndex="9" ValidationGroup="TLDFirmwareValidation" />
