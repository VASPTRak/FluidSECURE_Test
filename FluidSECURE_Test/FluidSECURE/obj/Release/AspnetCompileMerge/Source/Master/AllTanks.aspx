    ...
    <script>
        ...
        function OnSuccess(response) {
            ...
            if (response.d == 1) {
                ...
                $("#ErrorMessageNew").text("TANK CANNOT BE DELETED - This Tank is assigned to a FluidSecure Link(s) OR Tank Inventory record(s) against This Tank, please reassign the FluidSecure Link to another Tank OR Delete Tank Inventory record(s) against this Tank and return to Delete the Tank.");
            }
            else {
                $("#ErrorMessageNew").show();
                $("#messageNew").hide();
                    ...
                    <div class="col-md-12 col-sm-12  col-xs-12" style="overflow-x: auto">
                        ...
                        <asp:GridView ID="gvTank" CssClass="table table-bordered table-hover" runat="server" PageSize="10" AllowPaging="true" DataKeyNames="TankId"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField SortExpression="TempTankNumber" ItemStyle-HorizontalAlign="Center" HeaderText="Tank Number">
                                    <ItemTemplate>
