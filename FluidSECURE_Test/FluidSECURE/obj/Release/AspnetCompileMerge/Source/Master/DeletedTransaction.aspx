<%@ Page Title="Deleted Transaction" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="DeletedTransaction.aspx.vb" Inherits="Fuel_Secure.DeletedTransaction" %>
                ...
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div id="divPrevHours" runat="server">
                            ...
                            <div class="form-group col-md-3 col-sm-3 col-xs-12">
                                <asp:TextBox ID="txtPreviousHours" runat="server" CssClass="form-control input-sm" MaxLength="7" Width="70" TabIndex="18" Text="0" onkeypress="return onlyNumbers(event);"></asp:TextBox>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            ...
                            <asp:DropDownList ID="DDL_Fuel" runat="server" TabIndex="19" CssClass="form-control input-sm" Enabled="false"></asp:DropDownList>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList ID="DDL_Customer" runat="server" CssClass="form-control input-sm" TabIndex="20" AutoPostBack="true" OnSelectedIndexChanged="DDL_Customer_SelectedIndexChanged"></asp:DropDownList>
                    ...
                    <div class="row col-md-12 col-sm-12 text-center col-xs-12">
                        <asp:Button ID="btnSave" CssClass="btn btn-primary" runat="server" OnClick="btnSave_Click" Text="Save & UnDelete" Width="150px"
