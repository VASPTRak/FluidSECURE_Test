            ...
            <div class="panel panel-primary" style="margin: 20px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="txtTransactionDate" runat="server" Width="100" Style="float: left; margin-right: 10px;" CssClass="form-control input-sm" TabIndex="11"></asp:TextBox>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="txtTransactionTime" runat="server" Width="150" CssClass="form-control input-sm" TabIndex="12"></asp:TextBox>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <input type="button" id="BTN_Persons" tabindex="15" onclick="OpenPersonTypeBox();" value="Click to add Person" />
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="txtPinNumber" runat="server" CssClass="form-control input-sm" MaxLength="10" Width="95" TabIndex="14" OnTextChanged="txtPinNumber_TextChanged" AutoPostBack="true"></asp:TextBox>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            ...
                            <asp:DropDownList ID="DDL_Fuel" runat="server" TabIndex="6" CssClass="form-control input-sm" Enabled="true"></asp:DropDownList>
                        ...
                        <div id="PreviousOdometer" runat="server">
                            ...
                            <div class="form-group col-md-3 col-sm-3 col-xs-12">
                                <asp:TextBox ID="txtPreviousOdometer" runat="server" CssClass="form-control input-sm" MaxLength="7" Width="70" TabIndex="16" Text="0" onkeypress="return onlyNumbers(event);"></asp:TextBox>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="txtHours" runat="server" CssClass="form-control input-sm" MaxLength="10" Width="95" TabIndex="17" onkeypress="return onlyNumbers(event);"></asp:TextBox>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div id="divPrevHours" runat="server">
                            ...
                            <div class="form-group col-md-3 col-sm-3 col-xs-12">
                                <asp:TextBox ID="txtPreviousHours" runat="server" CssClass="form-control input-sm" MaxLength="18" Width="70" TabIndex="17" Text="0" onkeypress="return onlyNumbers(event);"></asp:TextBox>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList ID="DDL_TransactionStatus" runat="server" TabIndex="19" CssClass="form-control input-sm">
                            </asp:DropDownList>
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList ID="DDL_Customer" runat="server" CssClass="form-control input-sm" TabIndex="9" AutoPostBack="true" OnSelectedIndexChanged="DDL_Customer_SelectedIndexChanged"></asp:DropDownList>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="txtCost" runat="server" CssClass="form-control input-sm" Width="80px" TabIndex="7" onchange="return onlyDecimal();"></asp:TextBox>
                            <label runat="server" id="lblCost" style="color: red"></label>
                            <%--<asp:RequiredFieldValidator ID="RFD_FuelQuantity" runat="server" ControlToValidate="txtCost" Display="Dynamic" ErrorMessage="Please enter Fuel Quantity." ForeColor="Red" SetFocusOnError="True" ValidationGroup="TransactionValidation"></asp:RequiredFieldValidator>--%>
                            <%-- <asp:CompareValidator ID="CV_Cost" runat="server" Display="Dynamic" ErrorMessage="Please enter Cost in decimal format." ForeColor="Red" Operator="DataTypeCheck" SetFocusOnError="True" Type="Double" ValidationGroup="TransactionValidation" ControlToValidate="txtCost"></asp:CompareValidator>--%>

                            <%-- <label style="font-weight: bold">$</label><label runat="server" id="lblCost" style="font-weight: bold"></label>--%>
                        </div>
                        <div runat="server" id="divOffSet" visible="false">
                            <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                                <label>
                                    OFF Site:</label>
                            </div>
                            <div class="form-group col-md-3 col-sm-3 col-xs-12">
                                <asp:CheckBox runat="server" ID="chkOFFSite" Checked="True" />
                            </div>
                        </div>
                    </div>
