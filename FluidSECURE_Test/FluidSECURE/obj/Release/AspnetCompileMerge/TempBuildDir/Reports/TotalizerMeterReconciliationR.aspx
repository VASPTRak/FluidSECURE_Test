<%@ Page Title="Totalizer/Meter Reconciliation Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TotalizerMeterReconciliationR.aspx.vb" Inherits="Fuel_Secure.TotalizerMeterReconciliationR" %>
        ...
        <ContentTemplate>
            <div class="panel panel-primary" style="margin: 20px;">
                <div class="panel-heading  text-center">
                    <asp:Label class="panel-title" ID="lblHeader" runat="server">Totalizer Reconciliation Report</asp:Label>
                </div>
                <div class="panel-body">
                    ...
                    <%--<div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="txtEndDateTo" runat="server" Width="100" Style="float: left; margin-right: 10px;" CssClass="form-control input-sm" TabIndex="3"></asp:TextBox>
                        </div>
                    </div>--%>
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList ID="DDL_FluidLink" runat="server" CssClass="form-control input-sm" TabIndex="6" AutoPostBack="true" OnSelectedIndexChanged="DDL_FluidLink_SelectedIndexChanged"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList ID="ddlEndDateTIme" runat="server" CssClass="form-control input-sm" TabIndex="6"></asp:DropDownList>
                        </div>
                    </div>
                    <%--<div class="row col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="txtEndTimeTo" runat="server" Width="150" CssClass="form-control input-sm" TabIndex="4"></asp:TextBox>
                        </div>
                    </div>--%>
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        <%--<div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                    ...
                    <div class="row col-md-12 col-sm-12 text-center col-xs-12">
                        ...
                        <asp:Button ID="btnCancel" CssClass="btn btn-primary" runat="server" OnClick="btnCancel_Click" Text="Cancel" TabIndex="8"
