<%@ Page Title="Personnel Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="PersonnelReport.aspx.vb" Inherits="Fuel_Secure.PersonnelReport" %>
        ...
        <ContentTemplate>
            <div class="panel panel-primary" style="margin: 20px;">
                <div class="panel-heading  text-center">
                    <asp:Label class="panel-title" ID="lblHeader" runat="server">Personnel Report</asp:Label>
                </div>
