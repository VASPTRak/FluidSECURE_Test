            ...
            <div class="panel panel-primary" style="margin: 20px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12" id="Div1" runat="server">
                        ...
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                            <label>Vehicle Has a Fob:</label>
                        </div>
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:CheckBox ID="CHK_IsVehicleHasFob" runat="server" TabIndex="13" />
                            <asp:Label ID="lblIsVehicleHasFob" runat="server" Text="(MUST use the fob, and not use a vehicle number on HUB application)"></asp:Label>
                        </div>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12" id="divPricing" runat="server">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList ID="DDL_Costing" runat="server" TabIndex="14" CssClass="form-control input-sm">
                                <asp:ListItem Text="Select Costing Method" Value="0" Selected="true"></asp:ListItem>
                                <asp:ListItem Text="Fixed Price Costing" Value="1"></asp:ListItem>
                                <asp:ListItem Text="Price Average Costing" Value="2"></asp:ListItem>
                            </asp:DropDownList>
