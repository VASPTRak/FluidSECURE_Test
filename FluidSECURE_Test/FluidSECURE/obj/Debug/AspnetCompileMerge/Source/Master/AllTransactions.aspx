<%@ Page Title="Transactions" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AllTransactions.aspx.vb" Inherits="Fuel_Secure.AllTransactions" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <ContentTemplate>
            <div class="panel panel-primary" style="margin: 20px;">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">Transactions</h3>
                </div>
                <div class="panel-body">
                    <div class="row col-md-12 col-sm-12  col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3  col-xs-12" id="OtherThanTransDate1" runat="server">
                            ...
                            <%--<asp:DropDownList runat="server" ID="DDL_users" Visible="false" CssClass="form-control input-sm"></asp:DropDownList>--%>
                            <asp:DropDownList runat="server" ID="DDL_Missed" Visible="false" CssClass="form-control input-sm">
                                ...
                                <asp:ListItem Text="User Stopped" Value="UserStopped"></asp:ListItem>
                                <asp:ListItem Text="Is Missed" Value="IsMissed"></asp:ListItem>
                    ...
                    <div class="col-md-12 col-sm-12  col-xs-12" style="overflow-x: auto">
                        ...
                        <asp:GridView ID="gvTransactions" CssClass="table table-bordered table-hover" runat="server" PageSize="20" AllowPaging="true"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Click to See FSVM Data">
                                    <ItemTemplate>
                                        <asp:Button runat="server" ID="btnFSVM" Text="FSVM Data" OnClick="btnFSVM_Click" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="myModalVehicleRecurringMSG">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title text-center">Vehicle Recurring Message Details</h3>
                </div>
                 <asp:UpdatePanel ID="UP_VehicleRecurringMSG" runat="server">
                                    <ContentTemplate>
                <div class="modal-body">
                    ...
                    <div class="col-md-12 col-sm-12  col-xs-12">
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <label>
                                RPM:</label>
                            <asp:Label ID="lblRPM" runat="server" Style="font-weight: bold; font-size: 15px"></asp:Label>
                        </div>
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <label>
                                SPD:</label>
                            <asp:Label ID="lblSPD" runat="server" Style="font-weight: bold; font-size: 15px"></asp:Label>
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-12  col-xs-12">
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <label>
                                MIL:</label>
                            <asp:Label ID="lblMIL" runat="server" Style="font-weight: bold; font-size: 15px"></asp:Label>
                        </div>
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <label>
                                PC:</label>
                        ...
                        <asp:GridView ID="grdVehicleRecurringMSG" CssClass="table table-bordered table-hover" runat="server" PageSize="20" AllowPaging="true"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Left"
                                    HeaderText="PIDs">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPID" Text='<%# DataBinder.Eval(Container.DataItem, "ColName")%>'
                                            runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Left"
                                    HeaderText="PID Value">
                                    <ItemTemplate>
                                        <asp:Label ID="lblPIDValue" Text='<%# DataBinder.Eval(Container.DataItem, "ColValue")%>'
                                            runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                ...
                <div class="modal-footer nextButton">
                    <button type="button" id="btnMyVehicleRecurringMSGClose" class="btn btn-default" data-dismiss="modal" onclick="return false;">OK</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
    ...
    <script type="text/javascript">
        ...
        function openVehicleRecurringMSGModal() {
            $('#myModalVehicleRecurringMSG').modal({
                show: true,
                backdrop: 'static',
                keyboard: false
            });
