<%@ Page Title="All Products" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AllFuels.aspx.vb" Inherits="Fuel_Secure.AllFuels" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script>
        ...
        function DeleteRecord() {
            ...
            var FuelTypeID = $("#hdnFuelTypeID").val();

            $.ajax({
                type: "POST",
                url: "AllFuels.aspx/DeleteRecord",
        ...
        function OnSuccess(response) {
            ...
            if (response.d == 1) {
                ...
                window.location.href = "/Master/AllFuels"
        ...
        function CheckConfirm(FuelTypeID) {
            var Role = '<%= Session("RoleName") %>';

            if (Role == "SuperAdmin") {
                $("#lblMessage").text("Are you sure you want to delete this Fluid?");
            }
            else {
                $("#lblMessage").text("Are you sure you want to delete this Fluid?");
            }

            $("#hdnFuelTypeID").val(FuelTypeID);
            ...
            <div class="panel panel-primary" style="margin: 20px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12 text-right" style="margin-bottom: 10px;">
                        <asp:Button ID="btn_New" CssClass="btn btn-primary" runat="server" Text="Add new Product" OnClick="btn_New_Click" />
                    </div>
                    <div class="col-md-12 col-sm-12  col-xs-12" style="overflow-x: auto">

                        <asp:GridView ID="gvFuelType" CssClass="table table-bordered table-hover" runat="server" PageSize="10" AllowPaging="true" DataKeyNames="FuelTypeID"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Delete">
                                    <ItemTemplate>
                                        <a style="color: #428BCA" href="javascript:CheckConfirm(<%# DataBinder.Eval(Container.DataItem, "FuelTypeID")%>)">Delete</a>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="FuelType" ItemStyle-HorizontalAlign="Center" HeaderText="Products" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" id="hdnFuelTypeID" />
                    <h4 id="lblMessage"></h4>
                </div>
