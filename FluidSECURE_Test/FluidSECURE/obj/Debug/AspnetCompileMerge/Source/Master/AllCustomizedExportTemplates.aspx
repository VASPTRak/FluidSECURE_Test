<%@ Page Title="All Customized Export Templates" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AllCustomizedExportTemplates.aspx.vb" Inherits="Fuel_Secure.AllCustomizedExportTemplates" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      <script>
        ...
        function DeleteRecord() {
            ...
            var CustomizedExportTemplateId = $("#hdnCustomizedExportTemplateId").val();

            $.ajax({
                type: "POST",
                url: "AllCustomizedExportTemplates.aspx/DeleteRecord",
        ...
        function OnSuccess(response) {
            ...
            if (response.d == 1) {
                ...
                window.location.href = "/Master/AllCustomizedExportTemplates"
        ...
        function CheckConfirm(CustomizedExportTemplateId) {
            var Role = '<%= Session("RoleName") %>';

            if (Role == "SuperAdmin") {
                $("#lblMessage").text("Are you sure you want to delete this Customized Export Template?");
            }
            else {
                $("#lblMessage").text("Are you sure you want to delete this Customized Export Template?");
            }

            $("#hdnCustomizedExportTemplateId").val(CustomizedExportTemplateId);
        ...
        <ContentTemplate>
            <div class="panel panel-primary" style="margin: 20px;">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">Customized Export</h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12 text-right" style="margin-bottom: 10px;">
                        <asp:Button ID="btn_New" CssClass="btn btn-primary" runat="server" Text="Add new Customized Export Template" OnClick="btn_New_Click" />
                    </div>
                    <div class="col-md-12 col-sm-12  col-xs-12" style="overflow-x: auto">

                        <asp:GridView ID="gvCustomizedExportTemplate" CssClass="table table-bordered table-hover" runat="server" PageSize="10" AllowPaging="true" DataKeyNames="CustomizedExportTemplateId"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Delete">
                                    <ItemTemplate>
                                        <a style="color: #428BCA" href="javascript:CheckConfirm(<%# DataBinder.Eval(Container.DataItem, "CustomizedExportTemplateId")%>)">Delete</a>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="CustomizedExportTemplateName" ItemStyle-HorizontalAlign="Center" HeaderText="Template Name" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCustomizedExportTemplateName" Text='<%# DataBinder.Eval(Container.DataItem, "CustomizedExportTemplateName")%>'
                                            runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" id="hdnCustomizedExportTemplateId" />
                    <h4 id="lblMessage"></h4>
                </div>
