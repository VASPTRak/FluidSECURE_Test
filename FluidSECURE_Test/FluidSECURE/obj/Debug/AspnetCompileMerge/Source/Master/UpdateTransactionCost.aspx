            ...
            <div class="panel panel-primary" style="margin: 20px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12  col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3  col-xs-12">
                            <asp:TextBox ID="txt_Price" runat="server" CssClass="form-control input-sm col-md-2 col-sm-2" Style="width: 500px; float: left; margin-right: 10px;"></asp:TextBox>
                    ...
                    <div class="row col-md-12 col-sm-12  col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="txtStartDate" runat="server" CssClass="form-control input-sm col-md-2 col-sm-2" Style="width: 100px; float: left; margin-right: 10px;"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                            <label>
                                Start Time 
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="txtStartTime" runat="server" Width="150" CssClass="form-control input-sm" TabIndex="12"></asp:TextBox>
                    ...
                    <div class="row col-md-12 col-sm-12  col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="txtEndDate" runat="server" CssClass="form-control input-sm col-md-2 col-sm-2" Style="width: 100px; float: left; margin-right: 10px;"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                            <label>
                                End Time 
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="txtEndTime" runat="server" Width="150" CssClass="form-control input-sm" TabIndex="12"></asp:TextBox>
                    ...
                    <div class="row col-md-12 col-sm-12  col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3  col-xs-12">
                            <asp:Button runat="server" Text="Post Price" class="btn btn-success" ID="btnPostPrice" OnClick="btnPostPrice_Click" />
                            <asp:Button runat="server" Text="History" class="btn btn-default" ID="btnHistory" OnClick="btnHistory_Click" />
                            <asp:Button runat="server" Text="Cancel" class="btn btn-default" ID="btnCancel" OnClick="btnCancel_Click" />
                        </div>
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                        </div>
