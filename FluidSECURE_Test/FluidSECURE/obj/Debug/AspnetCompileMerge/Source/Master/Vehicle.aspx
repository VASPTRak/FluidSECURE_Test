                ...
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="txtVehicleNumber" CssClass="form-control input-sm" TabIndex="1" runat="server" MaxLength="10" Width="95"></asp:TextBox>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            ...
                            <asp:CompareValidator ID="CV_ExpectedMPGPerK" runat="server" Display="Dynamic" ErrorMessage="Please enter fuel limit per day in integer format." ForeColor="Red" Operator="DataTypeCheck" SetFocusOnError="True" Type="Double" ValidationGroup="VehicleValidation" ControlToValidate="TXT_ExpectedMPGPerK"></asp:CompareValidator>
                        </div>
                    </div>
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
