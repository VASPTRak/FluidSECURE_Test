<%@ Page Title="Transaction Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TransactionReportsByDateTime.aspx.vb" Inherits="Fuel_Secure.TransactionReportsByDateTime" %>
        ...
        <ContentTemplate>
            ...
            <div class="panel panel-primary" style="margin: 20px;">
                <div class="panel-heading  text-center">
                    <asp:Label class="panel-title" ID="lblHeader" runat="server">Transaction Report By Date Time</asp:Label>
                </div>
