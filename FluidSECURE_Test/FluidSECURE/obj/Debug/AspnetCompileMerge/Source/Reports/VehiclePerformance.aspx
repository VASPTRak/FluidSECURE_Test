                ...
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            ...
                            <asp:ListBox ID="lstSites" runat="server" SelectionMode="Multiple" CssClass="form-control input-sm"></asp:ListBox>
                        </div>
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                            <label>
                                Product:</label>
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            ...
                            <asp:RequiredFieldValidator ID="RDF_Fuel" runat="server" ControlToValidate="DDL_Fuel" Display="Dynamic"
                                ErrorMessage="Please select Fuel." ForeColor="Red" InitialValue="0" SetFocusOnError="True" ValidationGroup="TransactionValidation"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="row col-md-12 col-sm-12 text-center col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList runat="server" ID="DDL_VehicleType" CssClass="form-control input-sm">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="row col-md-12 col-sm-12 text-center col-xs-12">
