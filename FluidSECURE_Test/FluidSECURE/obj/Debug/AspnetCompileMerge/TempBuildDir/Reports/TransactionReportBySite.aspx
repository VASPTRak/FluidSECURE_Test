<%@ Page Title="Transaction Report by Site" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TransactionReportBySite.aspx.vb" Inherits="Fuel_Secure.TransactionReportBySite" %>
       ...
       <ContentTemplate>
            ...
            <div class="panel panel-primary" style="margin: 20px;">
                <div class="panel-heading  text-center">
                    <asp:Label class="panel-title" ID="lblHeader" runat="server">Transaction Report by Site</asp:Label>
                </div>
