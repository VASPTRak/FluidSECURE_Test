<%@ Page Title="Estimated Carbon Footprint by Vehicle" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="EstimatedCarbonFootprintbyVehicle.aspx.vb" Inherits="Fuel_Secure.EstimatedCarbonFootprintbyVehicle" %>
        ...
        <ContentTemplate>
            ...
            <div class="panel panel-primary" style="margin: 20px;">
                <div class="panel-heading  text-center">
                    <asp:Label class="panel-title" ID="lblHeader" runat="server">Estimated Carbon Footprint by Vehicle</asp:Label>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                         ...
                         <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList ID="DDL_Personnel" runat="server" TabIndex="13" Style="width: 150px; float: left; margin-right: 10px;" CssClass="form-control input-sm" OnSelectedIndexChanged="DDL_Personnel_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList ID="DDL_Fuel" runat="server" TabIndex="13" CssClass="form-control input-sm"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList ID="DDL_Order" runat="server" TabIndex="8" CssClass="form-control input-sm">
                                <asp:ListItem Text="Department" Value="DepartmentName"></asp:ListItem>
                                <asp:ListItem Text="Person" Value="PersonName"></asp:ListItem>
                                <asp:ListItem Text="Vehicle" Value="VehicleName"></asp:ListItem>
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList ID="ddl_ascDesc" runat="server" TabIndex="9" CssClass="form-control input-sm">
                    ...
                    <div class="row col-md-12 col-sm-12 text-center col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList ID="DDL_HubName" runat="server" TabIndex="14"   Style="width: 150px; float: left; margin-right: 10px;" CssClass="form-control input-sm" OnSelectedIndexChanged="DDL_HubName_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                    ...
                    <div class="row col-md-12 col-sm-12 text-center col-xs-12">
                        <asp:Button ID="btnGenarateReport" CssClass="btn btn-primary" runat="server" OnClick="btnGenarateReport_Click" Text="Generate Report"
                            UseSubmitBehavior="False" TabIndex="15" ValidationGroup="TransactionValidation" />
                    </div>
                </div>
            </div>
        </ContentTemplate>
