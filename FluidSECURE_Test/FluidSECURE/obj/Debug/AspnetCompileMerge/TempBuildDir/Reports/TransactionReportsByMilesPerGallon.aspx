<%@ Page Title="Transaction Reports By MPG/K" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TransactionReportsByMilesPerGallon.aspx.vb" Inherits="Fuel_Secure.TransactionReportsByMilesPerGallon" %>
        ...
        <ContentTemplate>
            ...
            <div class="panel panel-primary" style="margin: 20px;">
                <div class="panel-heading  text-center">
                    <asp:Label class="panel-title" ID="lblHeader" runat="server">Transaction Report By  Miles Per Gallon/Kilometer</asp:Label>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList ID="DDL_Customer" runat="server" CssClass="form-control input-sm" TabIndex="12" AutoPostBack="true" OnSelectedIndexChanged="DDL_Customer_SelectedIndexChanged"></asp:DropDownList>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            ...
                            <img src="../Content/images/icons8-search-50.png" onclick="OpenVehicleTypeBox();" style="width: 20px; vertical-align: -webkit-baseline-middle;" /><%--<input type="button" id="BTN_Vehicles" tabindex="15"  value="Click to add vehicle" />--%>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            ...
                            <asp:ListBox ID="lstSites" runat="server" SelectionMode="Multiple" TabIndex="7" CssClass="form-control input-sm"></asp:ListBox>
                        </div>
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                            <label>
                                Product:</label>
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList ID="DDL_Fuel" runat="server" TabIndex="14" CssClass="form-control input-sm"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                            <label>
                                MPG/K less than:</label>
                        </div>
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="TXT_MPGKLessThan" CssClass="form-control input-sm" TabIndex="8" runat="server" MaxLength="20" Width="200"></asp:TextBox>
                            <asp:CompareValidator ID="CV_ExpectedMPGPerK" runat="server" Display="Dynamic" ErrorMessage="Please enter Expected MPG / K in decimal format."
                                ForeColor="Red" Operator="DataTypeCheck" SetFocusOnError="True" Type="Double" ValidationGroup="TransactionValidation" ControlToValidate="TXT_MPGKLessThan"></asp:CompareValidator>
                        </div>
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                            <label>
                                MPG/K greater than:</label>
                        </div>
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="TXT_MPGKGreaterThan" CssClass="form-control input-sm" TabIndex="9" runat="server" MaxLength="20" Width="200"></asp:TextBox>
                            <asp:CompareValidator ID="CV_MPGKGreaterThan" runat="server" Display="Dynamic" ErrorMessage="Please enter Expected MPG / K in decimal format." ForeColor="Red"
                                Operator="DataTypeCheck" SetFocusOnError="True" Type="Double" ValidationGroup="TransactionValidation" ControlToValidate="TXT_MPGKGreaterThan"></asp:CompareValidator>
                        </div>
                    </div>
                    <div class="row col-md-12 col-sm-12 text-center col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList runat="server" ID="DDL_VehicleType" CssClass="form-control input-sm" TabIndex="10">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="row col-md-12 col-sm-12 text-center col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:DropDownList ID="DDL_TransactionStatus" runat="server" TabIndex="11" CssClass="form-control input-sm">
                                ...
                                <asp:ListItem Text="User Stopped" Value="0"></asp:ListItem>
                    ...
                    <div class="row col-md-12 col-sm-12 text-center col-xs-12">
                        <asp:Button ID="btnGenarateReport" CssClass="btn btn-primary" runat="server" OnClick="btnGenarateReport_Click" Text="Generate Report"
                            UseSubmitBehavior="False" TabIndex="16" ValidationGroup="TransactionValidation" />
                    </div>
                </div>
            </div>
        </ContentTemplate>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row col-md-12 col-sm-12" style="overflow-x: auto; max-height: 400px;">
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        <asp:GridView ID="grd_Per" CssClass="table table-bordered" runat="server" DataKeyNames="PersonId,PinNumber,Person" AutoGenerateColumns="False" EmptyDataText="Data Not found.">
                                            <Columns>
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
