<%@ Page Title="Transaction Report By Department" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TransactionReportByDepartment.aspx.vb" Inherits="Fuel_Secure.TransactionReportByDepartment" %>
       ...
       <ContentTemplate>
            ...
            <div class="panel panel-primary" style="margin: 20px;">
                <div class="panel-heading  text-center">
                    <asp:Label class="panel-title" ID="lblHeader" runat="server">Transaction Report by Department</asp:Label>
                </div>
