<%@ Page Title="Department Billing Report - Detail" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="BillingReportByDeptDetails.aspx.vb" Inherits="Fuel_Secure.BillingReportByDeptDetails" %>
       ...
       <ContentTemplate>
            ...
            <div class="panel panel-primary" style="margin: 20px;">
                <div class="panel-heading  text-center">
                    <asp:Label class="panel-title" ID="lblHeader" runat="server">Department Billing Report - Detail</asp:Label>
                </div>
