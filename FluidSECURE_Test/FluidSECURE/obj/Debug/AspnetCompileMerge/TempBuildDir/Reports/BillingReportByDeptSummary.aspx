<%@ Page Title="Billing Report - Department Summary" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="BillingReportByDeptSummary.aspx.vb" Inherits="Fuel_Secure.BillingReportByDeptSummary" %>
        ...
        <ContentTemplate>
            ...
            <div class="panel panel-primary" style="margin: 20px;">
                <div class="panel-heading  text-center">
                    <asp:Label class="panel-title" ID="lblHeader" runat="server">Billing Report - Department Summary</asp:Label>
                </div>
