<%@ Page Title="All Totalizer/Meter Reconciliation" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AllTotalizerMeterReconciliation.aspx.vb" Inherits="Fuel_Secure.AllTotalizerMeterReconciliation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script>
        ...
        function DeleteRecord() {
            ...
            $.ajax({
                type: "POST",
                url: "AllTotalizerMeterReconciliation.aspx/DeleteRecord",
        ...
        function OnSuccess(response) {
            ...
            if (response.d == 1) {
                ...
                window.location.href = "/Master/AllTotalizerMeterReconciliation?Type=" + $('#<%= hdnEntryType.ClientID %>').val()
        ...
        <ContentTemplate>
            ...
            <div class="panel panel-primary" style="margin: 20px;">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">Totalizer/Meter Reconciliation Process</h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12 text-right" style="margin-bottom: 10px;">
                        <asp:Button runat="server" ID="btnTotalizerMeterReconciliationReport" CssClass="btn btn-warning" Text="Totalizer Reconciliation Report" OnClick="btnTotalizerMeterReconciliationReport_Click"></asp:Button>
                        <asp:Button ID="btn_New" CssClass="btn btn-primary" runat="server" Text="Add new Totalizer/Meter Reconciliation" OnClick="btn_New_Click" />
                    </div>
                    <div class="col-md-12 col-sm-12  col-xs-12" style="overflow-x: auto">

                        <asp:GridView ID="gvTot" CssClass="table table-bordered table-hover" runat="server" PageSize="10" AllowPaging="true" DataKeyNames="TankInventoryId"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Delete" HeaderStyle-HorizontalAlign ="Center" HeaderStyle-VerticalAlign ="Middle">
                                 ...
                                 <asp:TemplateField SortExpression="FluidLink" ItemStyle-HorizontalAlign="Center" HeaderText="FluidLink" HeaderStyle-HorizontalAlign ="Center" HeaderStyle-VerticalAlign ="Middle">
                                    <ItemTemplate>
                                        <asp:Label ID="lblFluidLink" Text='<%# DataBinder.Eval(Container.DataItem, "FluidLink")%>'
                                            runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
