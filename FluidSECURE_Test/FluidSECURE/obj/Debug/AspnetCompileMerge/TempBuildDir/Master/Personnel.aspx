                ...
                <div class="panel-body">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <label class="text-danger font-required">[required]</label>:</label>
                            ...
                            <div class="form-group col-md-3 col-sm-3 col-xs-12">
                                <asp:DropDownList ID="DDL_AccessLevels" runat="server" CssClass="form-control input-sm" TabIndex="2"></asp:DropDownList>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12" id="VehicleHide1" runat="server">
                            ...
                            <asp:Button ID="btnAddVehicles" runat="server" Text="Click to add vehicle" OnClick="btnAddVehicles_Click" />
                        </div>
                    </div>
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:TextBox ID="txtPhoneNumber" runat="server" CssClass="form-control input-sm" MaxLength="15" Width="130" TabIndex="6" data-toggle="tooltip" title="Only (,),-, space, and + symbols allowed."></asp:TextBox> <%--data-toggle="tooltip" title="xxx-xxx-xxxx"--%>
                            ...
                            <asp:Label ID="lblErrorMsg" runat="server" ForeColor="Red" Style="display: none;" Text="Please enter valid contact number."></asp:Label> <%--Please enter valid US contact number in xxx-xxx-xxxx format.--%>
                        </div>
                        <div class="form-group col-md-3 col-sm-3 textright col-xs-12">
                            <label>
                    ...
                    <div class="row col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3 col-xs-12">
                            <asp:CheckBox ID="chkIsApproved" runat="server" TabIndex="20" />
                        </div>
                    </div>
