...
Public Class AutoTransactionExportSettings
	...
	Private Sub BindAutoTransactionExportSettingDetails(AutoTransactionExportSettingId As Integer)
		Try
			...
			If (dtAutoTransactionExportSetting.Rows.Count > 0) Then
				...
				HDF_TotalAutoTransactionExportSettings.Value = OBJMaster.GetAutoTransactionExportSettingIdByCondition(AutoTransactionExportSettingId, False, False, False, False, True, Session("RoleId").ToString(), Convert.ToInt32(Session("PersonId").ToString()))

				OBJMaster = New MasterBAL()
				Dim dtAllAutoTransactionExportSettings As DataTable = New DataTable()

				dtAllAutoTransactionExportSettings = OBJMaster.GetAutoTransactionExportSettingsByCondition("", Convert.ToInt32(Session("PersonId").ToString()), Session("RoleId").ToString())
	...
	Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
		...
		Try
			...
			result = OBJMaster.SaveUpdateAutoTransactionExportSetting(AutoTransactionExportSettingId, DDL_Company.SelectedValue, DDL_ExportOption.SelectedValue, CHK_Active.Checked, TXT_FTPServerPath.Text,
																	  ...
																	  chk_ExportZeroQtyTransactions.Checked, Convert.ToInt32(ddl_DecimalQTY.SelectedValue.ToString()), DecimalType, DDL_DateType.SelectedValue)
	...
	Protected Sub First_Click(sender As Object, e As EventArgs) Handles btnFirst.Click
		Try
			...
			OBJMaster = New MasterBAL()
			Dim AutoTransactionExportSettingId As Integer = OBJMaster.GetAutoTransactionExportSettingIdByCondition(CurrentAutoTransactionExportSettingId, True, False, False, False, False, Session("RoleId").ToString(), Convert.ToInt32(Session("PersonId").ToString()))
	...
	Protected Sub btnprevious_Click(sender As Object, e As EventArgs) Handles btnprevious.Click
		Try
			...
			OBJMaster = New MasterBAL()
			Dim AutoTransactionExportSettingId As Integer = OBJMaster.GetAutoTransactionExportSettingIdByCondition(CurrentAutoTransactionExportSettingId, False, False, False, True, False, Session("RoleId").ToString(), Convert.ToInt32(Session("PersonId").ToString()))
			HDF_AutoTransactionExportSettingId.Value = AutoTransactionExportSettingId
			BindAutoTransactionExportSettingDetails(AutoTransactionExportSettingId)
		Catch ex As Exception
	...
	Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
		Try
			...
			OBJMaster = New MasterBAL()
			Dim AutoTransactionExportSettingId As Integer = OBJMaster.GetAutoTransactionExportSettingIdByCondition(CurrentAutoTransactionExportSettingId, False, False, True, False, False, Session("RoleId").ToString(), Convert.ToInt32(Session("PersonId").ToString()))
			HDF_AutoTransactionExportSettingId.Value = AutoTransactionExportSettingId
			BindAutoTransactionExportSettingDetails(AutoTransactionExportSettingId)
	...
	Protected Sub btnLast_Click(sender As Object, e As EventArgs) Handles btnLast.Click
		Try
			...
			OBJMaster = New MasterBAL()
			Dim AutoTransactionExportSettingId As Integer = OBJMaster.GetAutoTransactionExportSettingIdByCondition(CurrentAutoTransactionExportSettingId, False, True, False, False, False, Session("RoleId").ToString(), Convert.ToInt32(Session("PersonId").ToString()))
			HDF_AutoTransactionExportSettingId.Value = AutoTransactionExportSettingId
			BindAutoTransactionExportSettingDetails(AutoTransactionExportSettingId)
