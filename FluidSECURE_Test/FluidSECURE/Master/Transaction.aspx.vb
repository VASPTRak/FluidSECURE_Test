...
Public Class Transaction
    ...
    Private Sub BindTransactionsDetails(TransactionId As Integer)
        Try
            ...
            If (dtTransaction.Rows.Count > 0) Then
                ...
                HDF_HubId.Value = dtTransaction.Rows(0)("HubId")
                ...
                HDF_TotalTransactions.Value = OBJMaster.GetTransactionIdByCondition(TransactionId, False, False, False, False, True, Convert.ToInt32(Session("PersonId").ToString()), Session("RoleId").ToString(), Session("CustomerId").ToString(), 0, False, strConditions)
                ...
                lblCostPerGallon.InnerText = dtTransaction.Rows(0)("CostPerGallon")
                lblSurchargeType.InnerText = dtTransaction.Rows(0)("SurchargeType")
                lblVehicleSum.InnerText = dtTransaction.Rows(0)("VehicleSum")
                lblDeptSum.InnerText = dtTransaction.Rows(0)("DeptSum")
                lblVehPercentage.InnerText = dtTransaction.Rows(0)("VehPercentage")
                lblDeptPercentage.InnerText = dtTransaction.Rows(0)("DeptPercentage")
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            dsTransactionValuesData = OBJMaster.GetTransactionColumnsValueForSave(txtDeptNo.Text, Convert.ToInt32(DDL_Fuel.SelectedValue), PersonId, Convert.ToInt32(HDF_VehicleId.Value))
