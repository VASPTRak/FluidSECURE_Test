		...
		Try
			...
			If dtVehicle IsNot Nothing Then
				If dtVehicle.Rows.Count > 0 Then
					...
					If dtVehicle.Rows(0)("FuelingType").ToString() = "False" Then
						gvVehicle.Columns(5).HeaderText = "Current Miles"
					Else
						gvVehicle.Columns(5).HeaderText = "Current Kilometers"
					End If
				End If
			End If
