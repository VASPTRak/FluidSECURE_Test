...
Public Class Vehicle
	...
	Private Sub ValidateAndSaveVehicle(IsSaveAndAddNew As Boolean)
		...
		Try
			...
			If (CHK_CheckOdometerReasonable.Checked = True And txtOdoLimit.Text = "0") Then
            ...
            result = OBJMaster.SaveUpdateVehicle(vehicleId, txtVehicleName.Text, txtMake.Text, txtModel.Text,
                                                 ...
                                                 txtVIN.Text, txtType.Text, txtDescription.Text, txtComment.Text,
                                                 ...
                                                 txtExportCode.Text, Convert.ToInt32(Session("PersonId")), DDL_Customer.SelectedValue, IIf(TXT_ExpectedMPGPerK.Text = "", "-1", TXT_ExpectedMPGPerK.Text), CHK_Hours.Checked, RBL_UnitType.SelectedValue, txtLicenseState.Text, RBL_OdometerReasonabilityConditions.SelectedValue,
                                                 TXT_FoBNUM.Text.Replace(" ", ""), CHK_Active.Checked, txtFSTagMacAddress.Text)
