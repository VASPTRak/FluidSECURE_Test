                ...
                <div class="panel-body">
                    <div class="row col-md-12 col-sm-12  col-xs-12">
                        ...
                        <div class="form-group col-md-3 col-sm-3  col-xs-12" id="OtherThanTransDate1" runat="server">
                            ...
                            <asp:DropDownList runat="server" ID="DDL_WifiSSIdFL" data-placeholder="Choose FluidSecure Link..." Visible="false" CssClass="form-control input-sm"></asp:DropDownList>
