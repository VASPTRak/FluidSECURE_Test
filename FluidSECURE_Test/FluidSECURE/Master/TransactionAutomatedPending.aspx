<%@ Page Title="Automated Pending" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TransactionAutomatedPending.aspx.vb" Inherits="Fuel_Secure.TransactionAutomatedPending" %>
		...
		<ContentTemplate>
			<div class="panel panel-primary" style="margin: 20px;">
				<div class="panel-heading">
					<h3 class="panel-title text-center">Automated Pending</h3>
				</div>
