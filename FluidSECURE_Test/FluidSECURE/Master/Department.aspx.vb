...
Public Class Department
    ...
    Private Sub ValidateAndSaveDept(IsSaveAndAddNew As Boolean)
        ...
        Try
            ...
            result = OBJMaster.SaveUpdateDept(DeptId, txtDeptName.Text, txtDeptNo.Text, txtAddress1.Text, txtAddress2.Text, txtAccNo.Text, DDL_Customer.SelectedValue, txtExportCode.Text, Convert.ToInt32(Session("PersonId")), VehSurSum, DeptSurSum, VehSurPer, DeptSurPer, Convert.ToInt32(DDL_SurType.SelectedValue), 0)
