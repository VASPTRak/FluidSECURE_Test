...
Public Class AllDeletedTransactions
    Inherits System.Web.UI.Page
    Private Shared ReadOnly log As ILog = LogManager.GetLogger(GetType(AllDeletedTransactions))
    ...
    '        dtPersonnel = OBJMaster.GetTransactionsByCondition(strConditions, Convert.ToInt32(Session("PersonId").ToString()), Session("RoleId").ToString(), True, 0, 0, False)
    ...
    Private Sub BindAllFluidSecureLink()
        Try
            ...
            strConditions = IIf(strConditions = "", " and Isnull(IsDeleted,0) = 1 and ISNULL(OFFSite,0) = 0 ", strConditions + " and Isnull(IsDeleted,0) = 1 and ISNULL(OFFSite,0) = 0 ")
    ...
    Protected Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        Try
            ...
            dsT = OBJMaster.GetTransactionsByCondition(strConditions, Session("PersonId").ToString(), Session("RoleId").ToString(), True, 0, 0, False, "", "")
    ...
    Protected Sub linkEdit_Click(sender As Object, e As EventArgs)
        Try
            ...
            Response.Redirect("DeletedTransaction?TransactionId=" & TransactionId, False)
        Catch ex As Exception
