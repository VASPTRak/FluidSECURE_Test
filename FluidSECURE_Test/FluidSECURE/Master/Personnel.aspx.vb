...
Public Class Personnel
    ...
    Private Sub BindAccessLevles()
        Try
            ...
            DDL_AccessLevels.DataSource = dtAccessLevels
    ...
    Protected Sub DDL_Customer_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DDL_Customer.SelectedIndexChanged
        Try
            ...
            If (HDF_PersonnelId.Value <> "") Then
                personid = Convert.ToInt32(HDF_PersonnelId.Value.ToString())
            End If
        ...
        Try
            ...
            Else
                If (CHK_HubUser.Checked = True) Then
                    ...
                    If (roleName = "GroupAdmin" And Session("RoleName") <> "SuperAdmin") Then
                        chkIsApproved.Checked = False
                    End If
    ...
    Private Function ValidateFields(PersonId As Integer) As Integer
        Try
            ...
            If (HDF_GroupAdmin.Value <> "00cee925-1cad-4650-9dc3-d1fdf74d1f5c") Then
            ...
            If (DDL_AccessLevels.SelectedValue = "52d3b8e6-95e6-44ac-b7bf-0be3acb56ff5" And Session("RoleName") <> "SuperAdmin") Then
                ErrorMessage.Visible = True
    ...
    Private Sub BindCompanies(PersonId As Integer, Roleid As String)
        ...
        Try
            ...
            If dtCompanies.Rows.Count = 0 Then
                lblSiteMessage.Text = "Companies not found, please try again later."
                lblSiteMessage.Visible = True
                gv_Sites.Visible = False
            End If
