...
Public NotInheritable Class CSCommonHelper
    ...
    Shared Function CheckExternalLogin(Context As OAuthGrantResourceOwnerCredentialsContext) As Integer

        Dim manager = HttpContext.Current.GetOwinContext().GetUserManager(Of ApplicationUserManager)()
        Dim UserObj As ApplicationUser = manager.Find(Context.UserName, Context.Password)
        If Not UserObj Is Nothing Then
            If UserObj.IsDeleted = False And UserObj.IsApproved = True Then
                Dim userRole = RoleActions.GetRolesById(UserObj.RoleId).Name
                If (userRole = "SuperAdmin" Or userRole = "GroupAdmin" Or userRole = "CustomerAdmin") Then
                    Return 1
                Else
                    Return -1
                End If
...
Public Class SSIDData
	...
	Public IsTLDFirmwareUpgrade As String
	Public TLDFirmwareFilePath As String
	Public TLDFIrmwareVersion As String
	Public TankId As String
	Public PROBEMacAddress As String
End Class
